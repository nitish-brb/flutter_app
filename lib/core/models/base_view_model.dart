...
import '../mixins/base_listenable_mixin.dart';
...
abstract class ReactiveViewModel extends BaseViewModel {
  late List<BaseListenableMixin> _reactiveServices;

  List<BaseListenableMixin> get reactiveServices;

  ReactiveViewModel() {
    _reactToServices(reactiveServices);
  }

  void _reactToServices(List<BaseListenableMixin> reactiveServices) {
