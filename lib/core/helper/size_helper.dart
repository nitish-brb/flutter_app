...
class SizeHelper {
  ...
  static Widget w9() => const SizedBox(width: 90);

  static Widget w10() => const SizedBox(width: 100);


  static Widget w11() => const SizedBox(width: 110);


  static Widget w12() => const SizedBox(width: 120);
}
